...
class RestGatewayTest extends GatewayTestCase
{
    ...
    public function testCapture()
    {
        ...
        $this->assertInstanceOf('\Omnipay\PayPal\Message\Rest\V1\RestCaptureRequest', $request);
    ...
    public function testRefund()
    {
        ...
        $this->assertInstanceOf('\Omnipay\PayPal\Message\Rest\V1\RestRefundRequest', $request);
        $this->assertSame('abc123', $request->getTransactionReference());
        $endPoint = $request->getEndpoint();
    ...
    public function testFetchTransaction()
    {
        ...
        $this->assertInstanceOf('\Omnipay\PayPal\Message\Rest\V1\RestFetchTransactionRequest', $request);
        $this->assertSame('abc123', $request->getTransactionReference());
        $data = $request->getData();
    ...
    public function testListPlan()
    {
        ...
        $this->assertInstanceOf('\Omnipay\PayPal\Message\Rest\V1\RestListPlanRequest', $request);
    ...
    public function testFetchPurchase()
    {
        ...
        $this->assertInstanceOf('\Omnipay\PayPal\Message\Rest\V1\RestFetchPurchaseRequest', $request);
        $this->assertSame('abc123', $request->getTransactionReference());
        $data = $request->getData();
        $this->assertEmpty($data);
    }
    ...
    public function testListPurchase()
    {
        ...
        $this->assertInstanceOf('\Omnipay\PayPal\Message\Rest\V1\RestListPurchaseRequest', $request);
    ...
    public function testRefundCapture()
    {
        ...
        $this->assertInstanceOf('\Omnipay\PayPal\Message\Rest\V1\RestRefundCaptureRequest', $request);
        $this->assertSame('abc123', $request->getTransactionReference());
        $endPoint = $request->getEndpoint();
    ...
    public function testVoid()
    {
        ...
        $this->assertInstanceOf('\Omnipay\PayPal\Message\Rest\V1\RestVoidRequest', $request);
        $this->assertSame('abc123', $request->getTransactionReference());
        $endPoint = $request->getEndpoint();
